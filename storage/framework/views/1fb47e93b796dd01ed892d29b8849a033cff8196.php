...
<head>
    ...
    <!-- iCheck -->
    <link href="<?php echo e(asset('/style/vendors/iCheck/skins/flat/green.css')); ?>" rel="stylesheet">

    <!-- bootstrap-progressbar -->
    <link href="<?php echo e(asset('/style/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css')); ?>" rel="stylesheet">
    <!-- JQVMap -->
    <link href="<?php echo e(asset('/style/vendors/jqvmap/dist/jqvmap.min.css')); ?>" rel="stylesheet" />
    <!-- bootstrap-daterangepicker -->
    <link href="<?php echo e(asset('/style/vendors/bootstrap-daterangepicker/daterangepicker.css')); ?>" rel="stylesheet">
...
<!-- Bootstrap -->
<script src="<?php echo e(asset('style/vendors/bootstrap/dist/js/bootstrap.bundle.min.js')); ?>"></script>
<!-- FastClick -->
<script src="<?php echo e(asset('style/vendors/fastclick/lib/fastclick.js')); ?>"></script>
<!-- NProgress -->
<script src="<?php echo e(asset('style/vendors/nprogress/nprogress.js')); ?>"></script>
<!-- Chart.js -->
<script src="<?php echo e(asset('style/vendors/Chart.js/dist/Chart.min.js')); ?>"></script>
<!-- gauge.js -->
<script src="<?php echo e(asset('style/vendors/gauge.js/dist/gauge.min.js')); ?>"></script>
<!-- bootstrap-progressbar -->
<script src="<?php echo e(asset('style/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js')); ?>"></script>
<!-- iCheck -->
<script src="<?php echo e(asset('style/vendors/iCheck/icheck.min.js')); ?>"></script>
<!-- Skycons -->
<script src="<?php echo e(asset('style/vendors/skycons/skycons.js')); ?>"></script>
<!-- Flot -->
<script src="<?php echo e(asset('style/vendors/Flot/jquery.flot.js')); ?>"></script>
<script src="<?php echo e(asset('style/vendors/Flot/jquery.flot.pie.js')); ?>"></script>
<script src="<?php echo e(asset('style/vendors/Flot/jquery.flot.time.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\e-kadai\resources\views/layout/nav.blade.php ENDPATH**/ ?>